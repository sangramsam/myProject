...
<nav class="navbar navbar-fixed-top  no-margin navbar-inner navbar-default navbar-inverse ">
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <a class="navbar-brand w" href="#"><h3><b>ITMU Moodle</b></h3></a>
        </div>
...
<%--     <%} %> --%>
  ...
  <%} %>
   ...
   <button type="button" class="btn btn-lg btn-primary" data-toggle="modal" data-target=".question"><span class="glyphicon glyphicon-plus-sign"></span>&nbsp;&nbsp;Question & Answer</button>
...
<div class="col-md-6">
    <div class="panel panel-danger panel-default " style="height: 240px;width: 600px;">
    ...
    <div class="form-group">
        <textarea cols="50" rows="5" class="form-control" placeholder="Ask Question ?" name="ques" id="ques"></textarea>
    </div>
    <div class="form-group">
