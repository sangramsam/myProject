...
<font size="+4" color="#66FF33"><u>Faculty Registration</u></font></div>
<div style="position:absolute; left: 525px; top: 184px; width: 339px; height: 370px;">
<table width="350" height="366">
<tr>
<td width="154"><font size="+2">Faculty ID:</font></td>
<td width="184"><input name="t1" type="text" /></td>
</tr>
<tr>
...
<tr>
<td height="56"><font size="+2">Confirm Password:</font></td>
...
<tr>
<td><font size="+2">Subject Name:</font></td>
<td><input type="text" name="t8" /></td>
</tr>
<tr>
<td><font size="+2">Subject ID:</font></td>
